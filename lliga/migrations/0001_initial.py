# Generated by Django 5.2.1 on 2025-05-19 08:25
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('equip', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='events', to='lliga.equip')),
                ('jugador', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='events', to='lliga.jugador')),
                ('partit', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='events', to='lliga.partit')),
            ],
        ),
    ]
